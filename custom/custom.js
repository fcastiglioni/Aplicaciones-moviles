	...
	mui.util.installEvents([
		...
		},
		{
			...
			fn: () => {
				...
				document.getElementById("subtitle").innerHTML = document.getElementById("gocontent1").innerHTML;
				fetchApi(document.getElementById("subtitle").innerHTML)
				return false;
			}
		},
		{
			...
			fn: () => {
				mui.viewport.showPage('content-page','DEF');
				document.getElementById("subtitle").innerHTML = document.getElementById("gocontent2").innerHTML;
				fetchApi(document.getElementById("subtitle").innerHTML)
				return false;
			}
		},
		{
			...
			fn: () => {
				mui.viewport.showPage('content-page','DEF');
				document.getElementById("subtitle").innerHTML = document.getElementById("gocontent3").innerHTML;
				fetchApi(document.getElementById("subtitle").innerHTML)
				return false;
			}
		},
		{
			...
			fn: () => {
				mui.viewport.showPage('content-page','DEF');
				document.getElementById("subtitle").innerHTML = document.getElementById("gocontent4").innerHTML;
				fetchApi(document.getElementById("subtitle").innerHTML)
				return false;
			}
		},
...
function fetchApi(cine){
    ...
    $.ajax({
        ...
        displayFilms(data.contentCinemaShows,cine);
    }).fail(function(jqXHR, textStatus, errorThrown) {
        console.log(textStatus);
    });
}

function displayFilms(data,cine){
    var found = false;
    var output = '';
    for(movie of data){
        console.log(movie);
        if(filterCinema(movie,cine)){
            output += `
                <div class="movie">
					<h1>'${movie.movie}'</h1>
					<div class="moviechart">
						...
						<span>'${movie.description}'</span>
						 <span class="genero">Genero: '${movie.genre}'</span>
						 <span class="trailer"><a href="${movie.trailerURL}">ver trailer</a></span>
					</div>
...
function filterCinema(movie,cine){
    for(contentCinemaShows of movie.cinemaShows){
        if (contentCinemaShows.cinema === cine ){
            return true;
        }
    }
    return false;
